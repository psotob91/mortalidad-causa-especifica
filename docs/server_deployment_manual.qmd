...
La capa semantica oficial y el mapa historico estan documentados en:
...
- `reports/deprecated/**`
- `scripts/deprecated/**`
- `R/diagnostics/deprecated/**`
- `R/maintenance/deprecated/**`
- scripts diagnosticos o de block1 fuera de la operacion vigente

## Fuera de operacion

- `tmp_*.R`
- pruebas ad hoc del root
- archivos scratch no gestionados por el runner
