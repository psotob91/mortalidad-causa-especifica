...
CFG <- list(
  version = "v0.4.0_terminal_audited",
  ...
  out_dir = here("data", "final", "mortality_rate_cause_smoothed"),
  qc_dir  = here("data", "derived", "qc", "09_build_mortality_rates"),
...
tryCatch({
  ...
  dth_raw[, location_id_dept := as.integer(substr(location_id_chr6, 1, 2))]
