...
CFG <- list(
  ...
  output_qc_dir  = qc_dir_path("diagnostic_mortality_qc_extra_block1_pdfs"),
...
# Ejecución directa
# ============================================================
run_iterative_diagnostics <- function(test_mode = CFG$test_mode) {
  run_qc_extra_bloque1(test_mode = test_mode)
}
